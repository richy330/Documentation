...
In order to be able to create our own Examples, it is important to understand the underlying structure necessary for a working Example. We will discuss each file needed in this chapter.
